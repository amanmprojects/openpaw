...
export async function createWorkspace(workspacePath: string): Promise<string> {
...
export async function readWorkspaceFile(workspacePath: string, filename: string): Promise<string | null> {
  try {
...
export async function needsBootstrap(workspacePath: string): Promise<boolean> {
  try {
